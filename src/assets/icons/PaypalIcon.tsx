...
const PaypallIcon = ({ className, width = '1rem', height = '1rem' }: IconProps) => {
   return (
      <svg
      ...
      >
         <g>
            ...
            <path
               ...
               fill='#1a80ad'
               data-original='#1a80ad'
            ></path>
            <path d='m436 176.4-20.8 104h25.6l21.6-104z' fill='#32a6ce' data-original='#32a6ce'></path>
            <path d='m454.4 176.4-39.2 104h25.6l21.6-104H436z' fill='#1a80ad' data-original='#1a80ad'></path>
            <path
            ...
            <path
               ...
               fill='#1a5b80'
               data-original='#1a5b80'
            ></path>
            <path
               d='M176 200.4h25.6l4 44.8 25.6-44.8h26.4l-60.8 112H168l18.4-33.6z'
               fill='#21789e'
               data-original='#21789e'
            ></path>
            <path
               d='m201.6 202 4 44 25.6-45.6h26.4l-60.8 112H168l18.4-32.8'
               fill='#1a5b80'
               data-original='#1a5b80'
            ></path>
            <path
            ...
            ></path>
            <path
               d='M127.2 228.4c-21.6 1.6-36 8-39.2 24-5.6 32 28.8 32.8 42.4 18.4l-1.6 9.6h25.6l4-19.2-31.2-32.8zm7.2 25.6c-1.6 6.4-7.2 8.8-13.6 9.6-5.6 0-10.4-3.2-6.4-9.6 3.2-4.8 10.4-4.8 15.2-4.8h6.4c-.8-.8-1.6 2.4-1.6 4.8zM207.2 244.4l-1.6 2.4 16.8 16 35.2-62.4h-26.4zM28 280.4l7.2-32-32.8 32z'
               fill='#06435e'
               data-original='#06435e'
            ></path>
            <path
               d='m276 280.4 7.2-33.6v.8l-32.8 32.8zM376 228.4c-21.6 1.6-36 8-39.2 24-5.6 32 29.6 32.8 43.2 18.4l-2.4 9.6h25.6l4-19.2-31.2-32.8zm7.2 25.6c-1.6 6.4-7.2 8.8-13.6 9.6-5.6 0-10.4-3.2-7.2-9.6 3.2-4.8 10.4-4.8 16-4.8h6.4c-.8-.8-1.6 2.4-1.6 4.8zM433.6 233.2l-18.4 47.2h25.6l7.2-32z'
               fill='#2273aa'
               data-original='#2273aa'
            ></path>
            <path
               d='M468 193.2V182h-4v-1.6h10.4v1.6h-4v11.2H468zM476 193.2v-12.8h2.4l3.2 8.8c0 .8.8 1.6.8 1.6 0-.8 0-.8.8-2.4l3.2-8.8h2.4v12.8h-1.6v-11.2l-4 11.2h-2.4l-4-11.2v11.2h-.8v.8z'
               fill='#32a6ce'
               data-original='#32a6ce'
            ></path>
         </g>
